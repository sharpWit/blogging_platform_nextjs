...
export function MainNav({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "container px-1 md:px-2 xl:px-4 flex flex-col space-y-3",
        className
      )}
    >
      {/* Top row */}
      <div className="flex justify-between items-center flex-1">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <Link href={"/rss" as Route}>
            <Icons.rss className="h-6 w-6 text-primary-foreground drop-shadow-md" />
          </Link>
        </div>
      </div>
      ...
      <div className="flex-1 self-start">
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <NavigationMenuTrigger className="shadow-md">
                Categories
              </NavigationMenuTrigger>
              <NavigationMenuContent>
            ...
            <NavigationMenuItem>
              <Link href={"/about" as Route} legacyBehavior passHref>
                <NavigationMenuLink
                  className={`${navigationMenuTriggerStyle()} shadow-md`}
                >
                  About
                </NavigationMenuLink>
              </Link>
